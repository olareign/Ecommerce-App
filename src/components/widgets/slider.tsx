...
export default function Slider({ interval = 4000 }: { height?: string; interval?: number }) {
    ...
    return (
        <div className="relative min-w-full max-w-7xl my-6">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-0.5 top-1/2 transform -translate-y-1/2 -translate-x-1/2 z-20 bg-white rounded-full shadow-lg hover:shadow-xl items-center justify-center w-16 h-16 md:w-18 md:h-18 border-4 border-white transition-all duration-200 hover:scale-105 hidden lg:flex outline-white outline-6"
            ...
            <button
                onClick={nextSlide}
                className="absolute right-0.5 top-1/2 transform -translate-y-1/2 translate-x-1/2 z-20 bg-white rounded-full shadow-lg hover:shadow-xl items-center justify-center w-16 h-16 md:w-18 md:h-18 border-4 border-white transition-all duration-200 hover:scale-105 hidden lg:flex outline-white outline-6"
