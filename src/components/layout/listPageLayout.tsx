...
export default function ListPageLayout({
  ...
  }, [dynamicCategory, extractedCategories, isCategoryPage]);
  ...
  return (
    <section className="mb-8">
      <header className="pt-4 md:pt-8 mb-4 flex flex-col items-start border-b border-gray-300">
        <span className="inline-block border-b-3 border-blue-400 pb-1 text-clip font-semibold text-gray-500 text-xl md:text-2xl w-fit">
          {headerContent}
          {isCategoryPage ? (
      ...
      {/* Product List */}
      {isCategoryPage ? (
        <div className="mt-4 flex flex-row justify-start scroll-auto overflow-x-scroll pb-2">
        ...
        <div className="mt-4 flex flex-row justify-start scroll-auto overflow-x-scroll pb-2 gap-2">
